class TerminalResume {
  ...
  handleCommand(inputElement) {
    ...
    this.printToOutput(outputElement, `âžœ ${command}`, "command");
...
â•šâ•â•     â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â• â•šâ•â•â•â•â•â• `;
  ...
  showHelp(outputElement = this.output) {
    const title = this.wrapWithColor("ðŸš€ Available Commands\n\n", "#ffff00");
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">ðŸ’¼ Professional Experience</span>
...
${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
  ...
  showEducation(outputElement = this.output) {
    const education = `<span style="color: #ff8c00; font-weight: bold;">ðŸŽ“ Education</span>
...
${this.wrapWithColor("ðŸ›ï¸ Institution:", "#ff8c00")} ${this.wrapWithColor(
      "University of Tirana",
      "#ffffff"
    )}
${this.wrapWithColor("ðŸ“… Duration:", "#ff8c00")}    ${this.wrapWithColor(
      "2013 - 2016",
      "#ffffff"
    )}
${this.wrapWithColor("ðŸ“ Location:", "#ff8c00")}    ${this.wrapWithColor(
      "Tirana, Albania",
      "#ffffff"
    )}
...
${this.wrapWithColor(
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">ðŸ› ï¸ PROGRAMMING</span>
...
â€¢ ${this.wrapWithColor("CSS", "#ffffff")}`;
  ...
  showContact(outputElement = this.output) {
    const contact = `<span style="color: #ff8c00; font-weight: bold;">ðŸ“« Contact Information</span>
...
${this.wrapWithColor("ðŸŒ", "#ff8c00")}  ${this.wrapWithColor(
      "Website:",
      "#ff8c00"
    )} ${this.wrapWithColor(
...
${this.wrapWithColor("ðŸ’¼", "#ff8c00")}  ${this.wrapWithColor(
      "LinkedIn:",
      "#ff8c00"
    )} ${this.wrapWithColor(
