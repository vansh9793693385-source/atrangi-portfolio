/* Copyright (c) 2026 Vaibhav Yadav - All Rights Reserved */
...
╚â•â•     ╚â•â•╚â•â•  ╚â•â•╚â•â•  ╚â•â•╚â•â• ╚â•â•â•â•â•â• `;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Software Engineer • Bug Bounty Hunter\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Passionate IT student who loves building and breaking things",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor("⚡ The Builder", "#ff8c00")}
${this.wrapWithColor(
      "   Crafting clean, functional web experiences as a Full Stack",
      "#ffffff"
    )}
${this.wrapWithColor("   Developer. Turning complex problems into elegant APIs & UIs.", "#ff8c00")}

${this.wrapWithColor("⚡ The Hacker", "#ff8c00")}
${this.wrapWithColor(
      "   Bug Bounty Hunter digging into web apps for vulnerabilities.",
      "#ffffff"
    )}
${this.wrapWithColor(
      "   Sharpening my eye for detail and thinking like an attacker.",
      "#ffffff"
    )}

${this.wrapWithColor("⚡ The Learner", "#ff8c00")}
${this.wrapWithColor(
      "   Diving deep into Cybersecurity, CTF challenges, and open source.",
      "#ffffff"
    )}
${this.wrapWithColor("   Leveling up my skills one project at a time.", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      '"I don\'t just write code - I understand, test, and secure it."',
      "#ffffff"
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 My Professional Journey</span>

<span style="color: #00ffff;">2026 - Present | Bug Bounty Hunting</span>
${this.wrapWithColor(
      "Offensive security and Zero-day hunting",
      "#98fb98"
    )}

• ${this.wrapWithColor("Active Hunter", "#ffa07a")} - ${this.wrapWithColor(
      "Uncovering critical vulnerabilities across various global platforms.",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "Security Research",
      ...
      "Turning deep cybersecurity knowledge into actionable defense strategies.",
      "#ffffff"
    )}

<span style="color: #00ffff;">2025 | Ventured into Cybersecurity</span>
${this.wrapWithColor(
      "Ethical hacking and vulnerability assessment",
      "#98fb98"
    )}

• ${this.wrapWithColor("Certified Ethical Hacker", "#ffa07a")} - ${this.wrapWithColor(
      "Developed a hacker's mindset to secure application perimeters.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Pen-testing", "#ffa07a")} - ${this.wrapWithColor(
      "Hands-on experience in uncovering and patching security loopholes.",
      "#ffffff"
    )}

<span style="color: #00ffff;">2024 | Embraced Full-Stack Development</span>
${this.wrapWithColor(
      "Production-ready applications and modern web frameworks",
      "#98fb98"
    )}

• ${this.wrapWithColor("Fullstack Apps", "#ffa07a")} - ${this.wrapWithColor(
      "Crafting immersive user experiences with scalable backend architectures.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Modern Frameworks", "#ffa07a")} - ${this.wrapWithColor(
      "Mastered React, Node.js, and cloud ecosystems for high-performance systems.",
      "#ffffff"
    )}

<span style="color: #00ffff;">2023 | Started Engineering Journey</span>
${this.wrapWithColor(
      "Computer science fundamentals and software architecture",
      "#98fb98"
    )}

• ${this.wrapWithColor("Groundwork", "#ffa07a")} - ${this.wrapWithColor(
      "Understanding digital systems and how they operate under the hood.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Architecture", "#ffa07a")} - ${this.wrapWithColor(
      "Focus on building robust software foundations and data structures.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, React, Node.js, TypeScript, Google Cloud, Ethical Hacking Tools, Git, Docker",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:itzvaibhav@gmail.com" style="color: #ffffff; text-decoration: none;">itzvaibhav@gmail.com</a>',
      "#ffffff"
    )}

${this.wrapWithColor("Œ", "#ff8c00")}  ${this.wrapWithColor(
      "Website:",
      "#ff8c00"
    )} ${this.wrapWithColor(
      '<a href="https://my-storytelling-portfolio.vercel.app" target="_blank" style="color: #ffffff; text-decoration: none;">my-storytelling-portfolio.vercel.app</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/vaibhav-yadav-80b891330" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/vaibhav-yadav-80b891330</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "vaibhav@yadav: ~/interactive-resume";
...
╚â•â•     ╚â•â•╚â•â•  ╚â•â•╚â•â•  ╚â•â•╚â•â• ╚â•â•â•â•â•â• `;
    ...
    role.textContent = "Software Engineer • Bug Bounty Hunter";
    ...
    url.textContent = "vaibhavyadav.me";
